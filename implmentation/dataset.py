...
def mc10_data_model():
    ...
    folds_1 = [
    (np.arange(0, 500), np.arange(500, 650)) #,          # First 140 as test set
    ...
    model_dir = ['/mnt/data/supervised/aspp/antarctica_elenaaspp_0_fold__before_bce_itr_100000_train_0.000915_time_40174.057143.pth'
